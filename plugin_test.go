...
var expectedResources = map[string]expectedResource{
	...
	"ifunny-chat-listen-all":      {sdk.PRODUCER, []string{"auth-basic", "auth-bearer", "user-agent", "channels", "emit"}},
	...
	"ifunny-chat-history-explode": {sdk.TRANSFORMER, []string{"auth-basic", "auth-bearer", "user-agent", "limit", "accept", "emit"}},
